...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title"> Akanksha Rai
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description"> I'm a rising junior majoring in Computer Science and minoring in Economics from the University of Minnesota Twin-Cities </p>
